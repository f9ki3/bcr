...
<body>
    <div class="certificate-container">
        ...
        <div class="content">
            ...
            <p>This is to certify that <strong>' . htmlspecialchars(strtoupper($certificate['fullname'])) . '</strong>, of legal age, is a bona fide resident of this barangay with particular address at <strong>' . htmlspecialchars($certificate['address']) . '</strong>.</p>
            <p>This certification is issued upon the request of the above-named person for whatever legal purpose it may serve.</p>
            <p>Issued this <strong>' . date("jS", strtotime($certificate["request_date"])) . ' day of ' . date("F, Y", strtotime($certificate["request_date"])) . '</strong> at Bagong Silang, Caloocan City.</p>
        </div>
...
if (isset($_GET['download'])) {
    ...
    header("Content-Disposition: attachment; filename=certificate_{$cert_id}.html");
    echo $certificate_html;
    exit();
}
?>
